...
(848, 'pg_packages', '["pgsql-main patroni pgbouncer pgbackrest pg_exporter pgbadger vip-manager"]', 'PGSQL', 'PG_INSTALL', 'string[]', 'C', 'pg packages to be installed, `$v` will be replaced', NULL),
